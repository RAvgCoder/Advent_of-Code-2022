...
public class Day4CampCleanupP2 {
    public static void main(String[] args) {
        ...
        for (int i =0; i< p1P2TotalRange.length; i++){
            ...
            // 94{p1[1]} >= 3{p2[0]} && 96{p2[1]} >= 3{p2[0]} ==Aka must be within bounds of
            // each other hence overlapping
            if (p1SplitAt1 >= p2SplitAt0 && p2SplitAt1 >= p1SplitAt0){
                pairs++;
//                System.out.println("-------+++++-----");
